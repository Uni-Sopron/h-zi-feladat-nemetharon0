...
const Layout = ({ children }) => {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-5 py-6 sm:py-8">
      <header className="bg-white border border-slate-200 rounded-2xl px-4 sm:px-5 py-3 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 shadow-md">
      ...
      <main className="mt-4 bg-white border border-slate-200 rounded-2xl p-4 sm:p-6 shadow-md">
        {children}
      </main>
    </div>
  );
